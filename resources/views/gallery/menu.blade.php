<div class="search-section col-auto">
...
<div class="filter col-auto">
    <form class="filter-form row align-items-center" name="content-filter" method="GET" action="{{ route('gallery.index') }}">
        ...
        <button type="submit" class="btn col">Apply</button>
    </form>
</div>

<div class="gallery-user-menu col-auto">
    @if(Auth::user())
        <div class="user">
