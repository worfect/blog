    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form enctype="multipart/form-data" id="store-gallery-item">
                    ...
                    <div class="down">
                        ...
                        <ul class="dropdown-menu" id="dropdown-gallery-categories">
                            @foreach($items as $item)
                                <li class="dropdown-input"><label><input type="checkbox" name="categories[]" value="{{ $item->getattribute('name') }}"> {{ $item->getattribute('name') }}</label></li>
                            @endforeach
                        </ul>
